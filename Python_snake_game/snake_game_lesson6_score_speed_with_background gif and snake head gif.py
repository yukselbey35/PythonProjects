...
# we checked if the snake touch itself 
#Lesson 6th We will add score
...
import random
delay=0.1
#We need score variables
#Score can increase by eat food
score = 0
high_score = 0
...
#head.shape("square")   #We can use square for the snake head.
#head.color("orange")
...
#We will use Turtle Pen module
pen=turtle.Turtle()
pen.speed(0) #This is animation speed not turtle
pen.shape("square") #It doesn't matter
pen.color("white")
pen.penup()
pen.hideturtle()
pen.goto(0, 260)
...
while True:
    ...
    if head.xcor()>290 or head.xcor()<-290 or head.ycor()>290 or head.ycor()<-290:
        ...
        #Reset the score when we hit the wall or border
        score = 0
        pen.clear() #We need to use pen.clear to clean the turtle trail.
        pen.write("Score: {} High Score: {}".format(score, high_score),  align="center", font=("Courier", 10, "normal" ))
        
        #When the snake hit the wall or border we need Reset the delay
        delay = 0.1

        pen.clear() #We need to use pen.clear to clean the turtle trail to write clearly 
        pen.write("Score: {} High Score: {}".format(score, high_score),  align="center", font=("Courier", 10, "normal" ))
    ...
    if head.distance(food)<20: #We are using ready pythagorean function to measure distance between  food and snake. If distance is less than 20 that means tey are collided.
        ...
        #When the snake size increase snake will move faster. Need shorten the delay
        delay -=0.001

        #Increase the score when eat the apple
